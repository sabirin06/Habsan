...
import { StayGalleryModal } from "./StayGalleryModal"
...
export function StayGallery({
  ...
  const { isFavorite, toggleFavorite } = useFavorites(stayId)
  ...
  return (
    <>
      ...
      <StayGalleryModal open={open} onOpenChange={setOpen} images={safe} title={title} />
    </>
  )
}
