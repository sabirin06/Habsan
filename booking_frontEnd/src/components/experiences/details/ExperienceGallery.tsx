...
import { useExperienceFavorites } from "./useExperienceFavorites"
...
export function ExperienceGallery({
  ...
  const { isFavorite, toggleFavorite } = useExperienceFavorites(experienceId)
  ...
  return (
    <>
      ...
      <ExperienceGalleryModal open={open} onOpenChange={setOpen} images={safe} title={title} />
    </>
  )
}
